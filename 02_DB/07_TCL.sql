--TCL(Transation Contrl Language) : 트랜잭션 제어 언어
---(Transation : 업무, 처리)
...
--DEPARTMENT2 테이블을 복사한 DEPARTNEMT3 생성
...
COMMIT; --현재 트랜잭션에 저장된 DML(INSERT, UPDATE)을 실제 DB에 반영
...
ROLLBACK; --트랜잭션에 임시 저장된 내용을 모두 삭제ㄴ
