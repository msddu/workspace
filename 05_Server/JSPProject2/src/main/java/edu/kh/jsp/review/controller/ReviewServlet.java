...
public class ReviewServlet extends HttpServlet {
	...
	// doGet(req,resp) : GET방식 요청 처리 메서드
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//String[] req.getParameterValues("name속성값") : 파라미터 모두 얻어오기(배열 형태)
		...
		//Servlet에서 생성한 변수(str)를 요청 위임된 JSP에서 사용할 수 있도록 HttpServletRequest에 속성(필드)로 추가
		//				   K     V
