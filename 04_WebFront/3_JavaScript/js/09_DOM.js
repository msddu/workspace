...
document.getElementById("btn1").addEventListener("click", ()=>{
  ...
  //    : childNodes[인덱스]
  //#test의 자식 노드(list)에서 9번 인덱스 노드 얻어오기
  console.log(list[9]);
  ...
  //2) prepend("내용" 또는 노드 또는 요소) : 첫번째 자식으로 내용/노드/요소로 추가 
  //                                        + 맨개변수로 여러 값을 작성해 한 번에 추가 가능
  list[11].prepend("123123213","가나다라");


  //3) append("내용" 또는 노드 또는 요소) : 마지막 자식 내용/노드/요소로 추가 
  //                                        + 맨개변수로 여러 값을 작성해 한 번에 추가 가능
...
btn2.addEventListener("click", ()=>{
  ...
  //#test2를 기준으로 body태그의 첫번째 자식 요소(DOM) 선택
