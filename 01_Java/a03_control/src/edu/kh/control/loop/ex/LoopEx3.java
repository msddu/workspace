...
public class LoopEx3 {
	...
	public void ex3() {
		...
		while(input != 9) {//9입력 시 조건식이 false가 되어 while문 종료
			...
			System.out.println("2.떡볶이(3500원)");
			System.out.println("3.라면(4000원)");
			System.out.println("9.주문완료");
			
			System.out.print("메뉴선택 >>");
			input = sc.nextInt();  //input에 메뉴 번호를 저장
			...
			default : System.out.println("<<메뉴에 작성된 메뉴만 눌러주세요>>");
			
			}
			
			
		}
		System.out.println("주문메뉴: " + orderMenu);
