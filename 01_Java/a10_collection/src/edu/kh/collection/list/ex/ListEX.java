...
public class ListEX {
	 ...
	 * -특징 2: 순서가 구분되기 때문에 중복 데이트 저장 가능
	 * */
	...
	public void ex1() {
		...
		//boolean   ->      Boolean   
 		...
 		//상황에 따라 자동으로 기본<->객체 되도록 구현됨
 		//-->Auto Boxing /  Auto Unboxing (컬렉션에서 많이 사용)
 		System.out.println(list);
 		
 		//list에 크기 3을 초과해서 추가해도 
 		//자동으로 크기가 늘어나서 에러 발생x
 		list.add("크기 3 초과");
 		System.out.println(list);
